# Generated by Django 3.0.1 on 2020-03-11 13:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists.'}, max_length=250, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@]+$'), 'Name can only contain letters and character @', 'invalid')], verbose_name='user')),
